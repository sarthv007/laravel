      ...
      <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data" action="/update/{{$data['student']['id']}}/student">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>Email</label>
              <input type="email" class="form-control" value="{{ old('email',$data['student']['email'])}}" placeholder="Email" readonly="true">
                          </div>
           </div> 
        ...
        <div class="row">
              ...
              <input type="text" value="{{ isset($data['FeesDetails']->tution_fees)?$data['FeesDetails']->tution_fees:''}}" readonly="true" class="form-control" id="tution_fees" placeholder="Tution Fees">
              ...
              <div class="form-group col-md-6">
                ...
                <input readonly="true" type="text" class="form-control" id="development_fees" placeholder="Development Fees" value="{{ isset($data['FeesDetails']->development_fees)?$data['FeesDetails']->development_fees:''}}">
                <small class="error" id="development_fees_error" style="display: none;"></small>
            </div>

            <div class="form-group col-md-12">
                <label>Total Fees</label>
                <input value="{{ isset($data['FeesDetails']->total_fees)?$data['FeesDetails']->total_fees:''}}" readonly="true" type="text" class="form-control" id="total_fees" placeholder="Total Fees">
                <small class="error" id="development_fees_error" style="display: none;"></small>
            </div>
          </div>
