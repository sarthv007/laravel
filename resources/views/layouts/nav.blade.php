<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    @if(Auth::user()->role->role == 'principal')
      <a class="navbar-brand mr-1" href="index.html">Principal Panel</a>
    @endif

    @if(Auth::user()->role->role == 'teachers')
      <a class="navbar-brand mr-1" href="index.html">Teachers Panel</a>
    @endif

    @if(Auth::user()->role->role == 'hod')
      <a class="navbar-brand mr-1" href="index.html">HOD Panel</a>
    @endif
