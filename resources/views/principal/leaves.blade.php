              ...
              <table class="table table-bordered" id="1" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if($leave->approvedByPrincipal == "Pending")
                        <a href="/pricipal/{{$leave->id}}/approve">Approve</a>
                        <a href="/pricipal/{{$leave->id}}/decline">Decline</a>  
                      @endif

                      @if($leave->approvedByPrincipal == 'Approved')
                        <a href="/pricipal/{{$leave->id}}/decline">Decline</a>
                      @endif

                      @if($leave->approvedByPrincipal == 'Decline')
                        <a href="/pricipal/{{$leave->id}}/approve">Approve</a>
                      @endif
